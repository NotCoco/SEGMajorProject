...
public class HibernateUtility {
    ...
    public static Class entityclass; //Do you think it should know about its class? Revertable change to param
    /**
     * Gets the session factory created in this case specifically for the Page class
     * @return The session factory.
     */
    public static SessionFactory getSessionFactory() { //TODO Takes Class entityclass
    ...
    public static void setEntityClass(Class newEntityClass) {
        //assert TableEntity.class.isAssignableFrom(newEntityClass); //TODO should this be a thing?
